...
const CRITERIA = [
  ...
  "подтверждённая квалификация эксперта;",
  "наличие сертификатов Палаты судебных экспертов;",
  "статус СРО ЦСЭ, если эксперт является членом СРО;",
  "сведения и документы в профиле эксперта.",
];

const EXAMPLES = [
  "В новом доме, в который только что заселились, появилась трещина в стене от пола до потолка. Нужно понять причину и выбрать эксперта.",
  "После ДТП нужно оценить повреждения автомобиля и понять, какой эксперт подойдёт для расчёта ущерба и проверки документов.",
];
...
const SITUATIONS = [
  ...
  },
  {
    ...
    desc: "Подбор эксперта под предмет спора, документы и поставленные вопросы.",
  },
  {
    num: "3",
...
const WHY_PLATFORM = [
  {
    ...
    desc: "Перед размещением эксперты проходят проверку документов и квалификации.",
  },
  {
    title: "Сертификация",
    desc: "На платформе представлены эксперты, имеющие сертификаты Палаты судебных экспертов.",
  },
  {
    title: "СРО ЦСЭ",
    desc: "Для членов СРО ЦСЭ статус отображается в профиле эксперта.",
  },
  {
    title: "Прямой контакт",
    desc: "После подбора заказчик взаимодействует с экспертом напрямую.",
  },
];
...
const MATCHING_STEPS = [
  ...
  { n: "2", text: "Система определяет направление исследования и профиль эксперта." },
  { n: "3", text: "Заказчик изучает экспертов и данные в профиле." },
  { n: "4", text: "Заказчик выбирает эксперта и связывается с ним напрямую." },
];
        ...
        <div className="bg-white border-t border-[#D0D0D0]">
          <div className={`${W} py-14 sm:py-20`}>
            ...
            <p className="text-lg sm:text-xl font-bold text-[#111111] mb-4 leading-snug max-w-2xl">
              Опишите ситуацию — система подберёт подходящего эксперта
            </p>

            <p className="text-sm sm:text-base text-[#555555] leading-relaxed max-w-2xl">
              Не важно, требуется ли независимое исследование, рецензия, заключение эксперта
              или судебная экспертиза. Система помогает определить подходящее направление и
              подобрать экспертов по профилю задачи.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white border-t border-[#D0D0D0]">
          <div className={`${W} py-14 sm:py-20`}>
            ...
            <p className="text-sm sm:text-base text-[#666666] mb-10">
              Выберите ситуацию. Система поможет подобрать эксперта нужного профиля.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-start">
            ...
            <div className="space-y-5 lg:pt-14">
              <p className="text-sm sm:text-base text-white/80 leading-relaxed">
                Палата судебных экспертов занимается сертификацией экспертов и развитием профессионального сообщества экспертов.
              </p>
              <p className="text-sm sm:text-base text-white/80 leading-relaxed">
                Платформа позволяет заказчикам находить экспертов с подтверждённой квалификацией и актуальными документами.
              </p>
              <p className="text-sm sm:text-base text-white/80 leading-relaxed">
                Акцент сделан на прозрачности информации об экспертах: документы, квалификация, сертификаты и профессиональные статусы отображаются в профиле.
              </p>
            </div>
