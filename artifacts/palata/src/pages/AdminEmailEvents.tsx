    ...
    <AdminLayout>
      <div className="px-4 sm:px-6 lg:px-8 py-6 max-w-screen-2xl mx-auto">
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          ...
          <input
            className="text-xs border border-slate-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-[#16a34a]/30 w-44"
                  ...
                  return (
                    <tr key={r.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-3 py-2 max-w-[180px]">
                        {r.request_id ? (
                          <a href={`/requests/${r.request_id}`} className="text-indigo-600 hover:text-indigo-800 truncate block">
